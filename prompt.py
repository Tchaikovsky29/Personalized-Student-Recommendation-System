...
The dictionaries should contain two keys. Write a detailed description of the student's strengths/weaknesses for the description key,
and give a list of the topics of the strengths/weaknesses for the topics key. 
Make sure the output string format can be parsed using json.loads. Only return the list with the two dictionaries and nothing else.
